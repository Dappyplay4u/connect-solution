###############################################################################
# LightStream Business Unit — Variables
###############################################################################
...
variable "project_spec" {
  description = "Short project specifier for the instance alias (e.g. lightstream)"
  type        = string
}

variable "project_name" {
  description = "Short project name prefix (e.g. lightstream)"
  type        = string
}

variable "account" {
  description = "Account identifier segment (e.g. dev, prod)"
  type        = string
}

variable "lob" {
  description = "Line of business identifier (e.g. lightstream)"
  type        = string
}

variable "sdlc_env" {
  description = "Deployment environment: dev | prod | qa | test"
  type        = string
}
