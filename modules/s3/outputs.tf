...
output "call_recordings_bucket_id" {
  description = "S3 bucket ID for call recordings (used by connect-instance module)"
...
output "scheduled_reports_bucket_id" {
  description = "S3 bucket ID for scheduled reports (used by connect-instance module)"
...
output "chat_transcripts_bucket_id" {
  description = "S3 bucket ID for chat transcripts (used by connect-instance module)"
...
output "name_prefix" {
  description = "Base name prefix used by this module  (e.g. tfc-retail-connect-tccivr)"
  value       = "${local.prefix}-${local.account}-connect-${local.lob}"
}
